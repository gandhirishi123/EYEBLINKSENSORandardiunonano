...
unsigned long currentMillis;          // Variabele to store the number of milliseconds since the Arduino has started
...
void readSensorState() {
  // If the difference in time between the previous reading is larger than interval sensor
